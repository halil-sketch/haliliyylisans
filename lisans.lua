...
dogruip16 = "193.164.7.45"-- VipScripting MariaRP
dogruip17 = "185.254.30.120"-- VipScripting KutsalIsik 450
dogruip18 = "217.195.207.25"-- VipScripting VeronicaRP
dogruip19 = "217.195.202.79"-- Cyruss gaddasım
...
dogruip25 = "217.195.207.78"-- 150 yeni
dogruip26 = "217.195.197.100"-- 966343393036877864
...
function Magic(res)
    ...
    serverip = ip 
		if tostring(ip) then 
				if ip == Haliliyy or ip == dogruip2 or ip == dogruip3 or ip == dogruip4 or ip == dogruip5 or ip == dogruip6 or ip == dogruip7 or ip == dogruip8 or ip == dogruip9 or ip == dogruip10 or ip == minecraft or ip == dogruip11 or ip == dogruip12 or ip == dogruip13 or ip == dogruip14 or ip == dogruip15 or ip == dogruip16 or ip == dogruip17 or ip == dogruip18 or ip == dogruip19 or ip == dogruip20 or ip == dogruip21 or ip == dogruip22 or ip == dogruip23 or ip == dogruip24 or ip == dogruip25 or ip == dogruip26 then 
